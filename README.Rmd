...
* Provides a simple interface `NMreadSim()` to read previously performed simulation results. Automatically stores results in a compressed format that can be separated from intermediate results files. 
