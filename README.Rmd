...
# NMdata<a href='https://NMautoverse.github.io/NMdata/'><img src='man/figures/NMsimlogo_alternate.png' align="right" height="120" /></a>
<!-- badges: start -->
...
This example was a simulation of a multiple dose regimen with a loading dose using a model estimated on single dose data. It is from the first vignette [`NMsim-basics.html`](https://NMautoverse.github.io/NMsim/articles/NMsim-basics.html).
...
started with
[`NMsim-basics.html`](https://NMautoverse.github.io/NMsim/articles/NMsim-basics.html). It
is really easy.
