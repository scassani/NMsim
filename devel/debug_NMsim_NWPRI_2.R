...
NMdataConf(path.nonmem="/data/sandbox/trunk/analysis/NMsim/nonmem760/nm760/run/nmfe76",
           as.fun="data.table")
...
NMexec("NMsim/devel/simtmp_NWPRI_nm76/simtmp_NWPRI/mod_lorlatinib_estimate_NWPRI/mod_lorlatinib_estimate_NWPRI_2.mod",sge=F)
NMexec("NMsim/devel/simtmp_NWPRI_nm76/simtmp_NWPRI/xgxr032_NWPRI/xgxr032_NWPRI_2.mod",sge=F)

simres <- NMscanData("NMsim/devel/simtmp_NWPRI_nm76/simtmp_NWPRI/mod_lorlatinib_estimate_NWPRI/mod_lorlatinib_estimate_NWPRI_2.lst")
simres <- NMscanData("NMsim/devel/simtmp_NWPRI_nm76/simtmp_NWPRI/xgxr032_NWPRI/xgxr032_NWPRI_2.lst")
