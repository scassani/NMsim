...
*** TODO [#A] Include row counter in input data - merge by it

**** TODO put the name of row counter in meta data

**** TODO Add it to all output tables

**** TODO have NMreadTabFast merge by it

**** TODO have NMscanData merge by it

**** TODO Remove it from results
...
*** TODO Only paste lst bottom if lst and tables not found
