...
## simres.forest.all[,.N,by=covlabel]
simres.forest.all[covlabel=="Bodyweigt (kg)",covlabel:="Bodyweight (kg)"]
...
ggplot(sum.uncertain[period=="Steady-State"],aes(predmm,covvalf,colour=method))+
    geom_rect(aes(xmin=.8,xmax=1.2,ymin=-Inf,ymax=Inf,colour=NULL),fill="grey90")+
