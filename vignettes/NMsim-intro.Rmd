...
<img src="../reference/figures/NMsimlogo.png" alt="NMsim" style="width:200px; float:right;">
...
<summary>Plot simulation results (click to show code)</summary>
...
As long as those requirements are met, there are no requirements to how the data sets are created. So if you already have a prefered way to do this, that's fine. NMsim provides convenient helper functions that can optionally be used. `NMcreateDoses()` creates just the dosing events, and `addEVID2()`
...
`addEVID2()` provides a similarly flexible interface. It accepts
...
<details>
<summary>Additional `addEVID2()` examples</summary>
```{r,addEVID2-extra1,eval=TRUE}
...
<summary>Derive and plot 90% prediction intervals</summary>
...
<summary>Click to show R console output from NMsim</summary>
