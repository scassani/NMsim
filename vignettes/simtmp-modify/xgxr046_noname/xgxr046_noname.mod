...
$DATA ./NMsimData_xgxr046_noname.csv
IGN=@
...
$SIMULATION ONLYSIM (890261060) 

$TABLE      ROW LTVKA LTVV2 LTVCL KA V2 CL PRED IPRED Y NOPRINT
            FILE=xgxr046_noname_1.tab
$TABLE      ETAS(1:LAST) NOAPPEND NOPRINT FILE=xgxr046_noname_2.tab
